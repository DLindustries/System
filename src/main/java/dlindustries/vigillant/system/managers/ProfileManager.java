...
public final class ProfileManager {
	...
	private String folderName = "GYbyuiBUybYIUYBZ";
		...
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : system.INSTANCE.getModuleManager().getModules()) {
					JsonElement moduleJson = profile.get(String.valueOf(system.INSTANCE.getModuleManager().getModules().indexOf(module)));
		...
		try {
			if (!System.getProperty("os.name").toLowerCase().contains("win")) {
				...
				for (Module module : system.INSTANCE.getModuleManager().getModules()) {
					...
					profile.add(String.valueOf(system.INSTANCE.getModuleManager().getModules().indexOf(module)), moduleConfig);
				}
